import 'package:chap8_calculator/constant.dart';
                    ...
                    children: [
                      Align(
                        alignment:Alignment.bottomRight,
                          child: Text(userInput.toString(),style: TextStyle(fontSize: 40,color:white),)),
                      SizedBox(height: 20,),
                      Text(answer.toString(),style: TextStyle(fontSize: 50,color:white,fontWeight: FontWeight.bold),),
                    ],
                  ),
                ),
              ),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        MyButton(title: '/',color: orange,onPress: (){userInput+=' / ';setState(() {
                    ...
                    Row(
                      children: [
                        MyButton(title: '7',onPress: (){userInput+='7';setState(() {
                        ...
                        MyButton(title: 'x',color: orange,onPress: (){userInput+=' x ';setState(() {
                    ...
                    Row(
                      children: [
                        ...
                        MyButton(title: '=',color: orange,onPress: (){
                          equalPress();
                          setState(() {
